...
// Test Products Page
// File: frontend/src/app/test-products/page.jsx

import ProductGrid from '@/components/products/ProductGrid';
import { useFeaturedProducts } from '@/hooks/useProducts';
import Link from 'next/link';

function FeaturedProductsTest() {
    const { featuredProducts, isLoading, error } = useFeaturedProducts(4);

    if (isLoading) {
        return (
            <div className="bg-white rounded-lg shadow-md p-6">
                <h3 className="text-lg font-semibold mb-4">Featured Products (Loading...)</h3>
    ...
    return (
        <div className="bg-white rounded-lg shadow-md p-6">
            <h3 className="text-lg font-semibold mb-4">
                Featured Products ({featuredProducts.length} found)
            </h3>
    ...
    return (
        <div className="container mx-auto px-4 py-8">
            <div className="max-w-6xl mx-auto">
                ...
                <div className="mb-8 grid grid-cols-1 lg:grid-cols-3 gap-6">
                    ...
                    <div className="bg-blue-50 rounded-lg p-6">
                        ...
                        <ul className="text-blue-800 space-y-1 text-sm">
                            ...
                            <li>• GET /api/products/:id - Single product</li>
                            <li>• Pagination, filtering, search</li>
                            <li>• Featured products endpoint</li>
                        </ul>
                    </div>
                    ...
                    <div className="bg-green-50 rounded-lg p-6">
                        ...
                        <ul className="text-green-800 space-y-1 text-sm">
                            <li>• Products grid with API data</li>
                ...
                <div className="mb-8">
                    <FeaturedProductsTest />
                </div>

                {/* Full Products Grid */}
                <div className="bg-white rounded-lg shadow-md p-6">
                    <h2 className="text-xl font-semibold mb-6">Full Products Grid</h2>
                    <ProductGrid
                ...
                <div className="mt-8 bg-gray-50 rounded-lg p-6">
                    ...
                    <div className="text-sm text-gray-600 space-y-2">
                        ...
                        <p><strong>Test Status:</strong> API integration test page loaded successfully</p>
                    </div>
                </div>
            </div>
        </div>
